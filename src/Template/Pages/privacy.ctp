<?php $this->assign('title','個人情報保護方針');?>
...
<div class="other-content">
  ...
  <section class="section">
    <section class="content-header">
      ...
      <p class="sub-title">個人情報保護方針</p>
    </section>
    <hr>
    <section class="content-body">
      <p class="mb20">株式会社ティーエイチツー（以下、「当社」）は、本engolサイト上で提供するサービス（以下、「本サービス」）におけるプライバシー情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
      <p class="bold">第１条（プライバシー情報）</p>
      <ol class="mb20">
      ...
      <p class="bold">第２条（プライバシー情報の収集方法）</p>
      <ol class="mb20">
      ...
      <p class="bold">第３条（個人情報を収集・利用する目的）</p>
      <ol class="mb20">
      ...
      <p class="bold">第６条（個人情報の訂正および削除）</p>
      <ol class="mb20">
      ...
      <p class="bold">第８条（プライバシーポリシーの変更）</p>
      <ol class="mb20">
        <li>本ポリシーの内容は、ユーザーに通知することなく、変更することができるものとします。</li>
        <li>当社が別途定める場合を除いて、変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。</li>
      </ol>
      <p class="bold">第９条（お問い合わせ窓口）</p>
      <ol class="mb20">
        <p>本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
        <p>社名：株式会社ティーエイチツー</p>
        <p>連絡先：info@engol.jp</p>
      </ol>
    </section>
  </section>
</div>
